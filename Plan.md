...
* Поле "Номер карты"
Валидные данные: 16 арабских цифр (тестовые данные 1111 2222 3333 4444 для успешных операций)
* Поле "Месяц"
...
* ### **Оплата с валидными данными** 
1. Заполнить все поля валидными данными
2.  Нажать кнопку “Продолжить”

*Ожидаемый результат*: Отправка данных с сообщением "Успешно, операция одобрена банком."
![](./Screenshots/2.png)
...
* ###TK 03 **Оплата с невалидными данными в поле “Номер карты" (меньше 16 цифр)**
...
* ### TK 04 **Оплата с невалидными данными в поле “Номер карты" (все нули)**
...
* ### TK 05 **Оплата с невалидными данными в поле "Месяц"(цифра больше 12)**
...
* ### TK 06  **Оплата с невалидными данными в поле "Месяц"(два нуля)**
...
* ### TK 07 **Оплата с невалидными данными в поле "Год"(прошедшая дата)**
...
* ### TK 08 **Оплата с невалидными данными в поле "Год"(больше 5 лет)**
...
* ### TK 09 **Оплата с невалидными данными в поле "Владелец" (цифры)
...
* ### TK 10 **Оплата с невалидными данными в поле "Владелец" (Один символ в имени и фамилии)**
...
* ### TK 11 **Оплата с невалидными данными в поле "CVC/CVV"**
...
* ### TK 12 **Запрос в базу данных оплаты, проверяющие корректность внесения информации приложением(Успешная операция)**
...
* ### TK 13 **Запрос в базу данных оплаты, проверяющие корректность внесения информации приложением(Отказ банка)**
...
* ### TK 14 **Запрос в базу данных оплаты, проверяющие корректность внесения информации приложением(Успешная операция)**
...
* ### TK 15  **Запрос в базу данных оплаты, проверяющие корректность внесения информации приложением(Отказ банка)**
