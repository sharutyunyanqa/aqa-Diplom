...
**Заполнение способа оплаты валидными данными (happy path)**
* Поле "Номер карты"
...
* ###  **Оплата с невалидными данными в поле “Номер карты" (меньше 16 цифр)**
...
* ###  **Оплата с невалидными данными в поле “Номер карты" (все нули)**
...
* ###  **Оплата с невалидными данными в поле "Месяц"(цифра больше 12)**
...
* ###  **Оплата с невалидными данными в поле "Месяц"(два нуля)**
...
* ###  **Оплата с невалидными данными в поле "Год"(прошедшая дата)**
...
* ###  **Оплата с невалидными данными в поле "Год"(больше 5 лет)**
...
* ###  **Оплата с невалидными данными в поле "Владелец" (цифры)
...
* ###  **Оплата с невалидными данными в поле "Владелец" (Один символ в имени и фамилии)**
...
* ###  **Оплата с невалидными данными в поле "CVC/CVV"**
...
* ###  **Запрос в базу данных оплаты, проверяющие корректность внесения информации приложением(Успешная операция)**
...
* ###  **Запрос в базу данных оплаты, проверяющие корректность внесения информации приложением(Отказ банка)**
...
Автотесты должны быть готовы 27.11.2023, (Анализ тестов, заведение баг-репортов, составление плана отчетности)
